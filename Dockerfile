...
RUN cd /usr/local/src/ && \
    ...
    wget --no-check-certificate -c --header "Cookie: oraclelicense=accept-securebackup-cookie" http://mtrbucket:7990/projects/MTR/repos/pinpoint/raw/src/jdk-6u45-linux-amd64.rpm?at=refs%2Fheads%2Fmaster && \
    wget --no-check-certificate -c --header "Cookie: oraclelicense=accept-securebackup-cookie" http://mtrbucket:7990/projects/MTR/repos/pinpoint/raw/src/jdk-7u79-linux-x64.rpm?at=refs%2Fheads%2Fmaster && \
    wget --no-check-certificate -c --header "Cookie: oraclelicense=accept-securebackup-cookie" http://mtrbucket:7990/projects/MTR/repos/pinpoint/raw/src/jdk-8u201-linux-x64.rpm?at=refs%2Fheads%2Fmaster && \
    wget --no-check-certificate -c --header "Cookie: oraclelicense=accept-securebackup-cookie" http://mtrbucket:7990/projects/MTR/repos/pinpoint/raw/src/jdk-9.0.4_linux-x64_bin.rpm?at=refs%2Fheads%2Fmaster && \
